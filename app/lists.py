...
syn_contact = ["සම්බන්ධ", "දුරකථන" ,"අංකය", "ඇමතුම්", "සම්බන්ද", "විමසුම්"]
...
stop_words = ['මහතා','මහත්මිය','කර', 'ගත', 'හැකි', 'මන්ත්රීවරු', 'කරන','නියෝජනය','කළ', "මන්ත්‍රීවරු​න්", "මන්ත්‍රීවරු​", "පාර්ලිමේන්තුව","පාර්ලිමේන්තුවේ", "මුස්ලිම්", "හා","සම්පත්"]